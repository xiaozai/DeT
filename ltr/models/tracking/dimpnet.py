...
class DiMPnet_rgbcolormap_postmerge_twoextractor(nn.Module):
    """The DiMP network.
    args:
...
class DiMPnet_rgbcolormap_postmerge(nn.Module):
    ...
    def __init__(self, feature_extractor, classifier, bb_regressor, classification_layer, bb_regressor_layer, merge_type='mean', W_rgb=0.6, W_depth=0.4):
        super().__init__()
...
@model_constructor
def dimpnet50_rgbcolormap_postmerge_twoextractor(filter_size=1, optim_iter=5, optim_init_step=1.0, optim_init_reg=0.01,
              classification_layer='layer3', feat_stride=16, backbone_pretrained=True, clf_feat_blocks=0,
              clf_feat_norm=True, init_filter_norm=False, final_conv=True,
              out_feature_dim=512, init_gauss_sigma=1.0, num_dist_bins=5, bin_displacement=1.0,
              mask_init_factor=4.0, iou_input_dim=(256, 256), iou_inter_dim=(256, 256),
    ...
    # DiMP network
    net = DiMPnet_rgbcolormap_postmerge_twoextractor(feature_extractor=backbone_net, feature_extractor_depth=backbone_net_depth, classifier=classifier, bb_regressor=bb_regressor,
                  classification_layer=classification_layer, bb_regressor_layer=['layer2', 'layer3'],
