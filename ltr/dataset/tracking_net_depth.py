...
class TrackingNet_depth(BaseVideoDataset):
    """ TrackingNet dataset.
    ...
    """
    def __init__(self, root=None, image_loader=jpeg4py_loader, dtype='depth', set_ids=None, data_fraction=None):
        """
        args:
        ...
        """
        root = env_settings().trackingnetdepth_dir if root is None else root
